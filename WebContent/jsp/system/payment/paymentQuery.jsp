		...
		<s:form action="basePaymentAction" namespace="/system">
			...
			<table>
				<tr>
					...
					<td>
						<s:textfield name="basePaymentVO.id"></s:textfield>
					</td>
					<td>
						支付方式名称
					</td>
					<td>
						<s:textfield name="basePaymentVO.paymentName"></s:textfield>
					</td>
					<td>
						备注
					</td>
					<td>
						<s:textarea name="basePaymentVO.remark"></s:textarea>
					</td>
				</tr>
				<tr>
					<td colspan="4">
				...
				<tr>
					<td>
						<display:table name="list" class="simple"
							...
							<display:column property="id" title="支付方式编号"></display:column>
							<display:column property="paymentName" title="支付方式名称"></display:column>
							<display:column property="remark" title="备注"></display:column>
						</display:table>
					</td>
				</tr>
			</table>
			<hq:buttons function="27">
