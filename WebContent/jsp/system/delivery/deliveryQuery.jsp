...
<html>
	...
	<body>
		<s:form action="baseDeliveryAction" namespace="/system">
			<br>
			<table>
				<tr>
					<td>
					...
					<td>
						<s:textfield name="baseDeliveryVO.deliveryName"></s:textfield>
					</td>
					<td>
						备注
					</td>
				...
				<tr>
					<td colspan="4">
						<s:submit value="查  询" action="baseDeliveryAction!query"></s:submit>
						&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td>
						<display:table name="list" class="simple"
							requestURI="baseDeliveryAction!query">
							...
							<display:column property="deliveryName" title="业务种类名称"></display:column>
							<display:column property="remark" title="备注"></display:column>
						</display:table>
					</td>
				</tr>
			</table>
			<hq:buttons function="24">
