...
<html>
	...
	<body>
		<s:form action="publicSysCustAction" namespace="/sysCust" method="post">
						...
						<table width="100%">
							<tr>
								<td>
									<div align="center">
										<s:if test="edit">
											<s:submit value="修  改" action="publicSysCustAction!update"
												onclick="return submitCheck(this);"></s:submit>
										</s:if>
										<s:else>
											<s:submit value="增  加" action="publicSysCustAction!save"
												onclick="return submitCheck(this);"></s:submit>
										</s:else>
										&nbsp;&nbsp;
