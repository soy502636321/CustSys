...
<html>
	...
	<body>
		<s:form action="privateSysCustAction" namespace="/sysCust">
			<br>
			<table>
				<tr>
					<td colspan="4">
						<s:submit value="查  询" onclick="return openSearchDialog(this, 'privateSysCustAction!search', 500, 300);" action="privateSysCustAction!query" />
					</td>
				</tr>
				<tr>
					<td colspan="4">
				...
				<tr>
					<td>
						<display:table name="list" class="simple"
							requestURI="privateSysCustAction!query">
			...
			<hq:buttons function="100">
				...
				<hq:button name="放入公共客户" mode="more" location="this"></hq:button>
			</hq:buttons>
		</s:form>
	</body>
</html>